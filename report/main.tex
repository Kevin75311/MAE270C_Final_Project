...
\hypersetup{
    ...
    pdffitwindow=false,
    pdfstartview={FitH},
    pdftitle={Optimal Control of MRI-Guided Microwave Thermal Ablation},
    pdfauthor={Jing-Yuan (Kevin) Huang},
    pdfsubject={MAE 270C Course Project},
    pdfkeywords={MRI, thermal ablation, optimal control, Pennes bioheat, Pontryagin},
    pdfnewwindow=true,
    colorlinks=true,
    linkcolor=blue,
    citecolor=green,
...
\input{glossaries}
\makeglossaries
% The List of Abbreviations is intentionally omitted; disable glossary
% hyperlinks so in-text acronyms do not point to a non-printed target.
\glsdisablehyper
...
\input{chapter-problem-formulation.tex}
